            ...
            >
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
                ...
                <div style={{
                  ...
                  boxShadow: '0 3px 10px rgba(3,38,85,0.18)',
                }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  {/* Name */}
                  <p style={{ fontFamily: 'var(--font-ui)', fontSize: '0.9rem', fontWeight: 800, color: '#032655', margin: '0 0 3px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', letterSpacing: '-0.01em' }}>
                    {a.candidate_name}
                  </p>
                    ...
                    <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', marginTop: '8px', paddingTop: '8px', borderTop: '1px solid #EEF3F8' }}>
                      {a.current_ctc != null && (
                        <span style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', fontFamily: 'var(--font-ui)', fontSize: '0.72rem', color: '#5A7A9F', fontWeight: 600 }}>
                          <svg width="12" height="12" fill="none" stroke="#96AFCA" strokeWidth={2} viewBox="0 0 24 24">
          ...
          <div style={{ padding: '24px 28px 20px', borderBottom: '1px solid #EEF3F8', flexShrink: 0 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '18px', marginBottom: '14px' }}>
              ...
              <div style={{
                ...
                background: 'linear-gradient(135deg, #032655 0%, #0FB9B1 100%)',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                boxShadow: '0 6px 20px rgba(3,38,85,0.2)',
              }}>
              ...
              {/* Name + subtitle + meta */}
              <div style={{ flex: 1 }}>
                <h2 style={{ fontFamily: 'var(--font-ui)', fontSize: '1.2rem', fontWeight: 800, color: '#032655', margin: '0 0 3px', letterSpacing: '-0.03em' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '14px', flexWrap: 'wrap' }}>
                  ...
                  <span style={{ fontFamily: 'var(--font-ui)', fontSize: '0.72rem', color: '#96AFCA' }}>
                    Applied {new Date(selected.submitted_at).toLocaleDateString('en-IN', { day: 'numeric', month: 'short', year: 'numeric' })}
                  </span>
                </div>
              </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
              {selected.resume_url && (
                <a
                  href={selected.resume_url} target="_blank" rel="noopener noreferrer"
                  style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', padding: '8px 16px', borderRadius: '9px', background: '#032655', color: '#fff', textDecoration: 'none', fontFamily: 'var(--font-ui)', fontSize: '0.75rem', fontWeight: 700, flexShrink: 0 }}
                >
              ...
              {selected.linkedin_url && (
                <a
                  href={selected.linkedin_url} target="_blank" rel="noopener noreferrer"
              ...
              {selected.portfolio_url && (
                <a
                  href={selected.portfolio_url} target="_blank" rel="noopener noreferrer"
          ...
          <div style={{ flex: 1, overflowY: 'auto', padding: '22px 28px', display: 'flex', flexDirection: 'column', gap: '22px' }}>
            ...
            {selected.recruiter_note && (
              <div>
                ...
                <div style={{ background: '#F0FBF9', border: '1px solid rgba(15,185,177,0.18)', borderRadius: '10px', padding: '14px 16px' }}>
                  <p style={{ fontFamily: 'var(--font-ui)', fontSize: '0.85rem', color: '#032655', lineHeight: 1.75, margin: 0 }}>
                    {selected.recruiter_note}
                  </p>
                </div>
              </div>
            ...
            {(selected.email || selected.phone) && (
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  {selected.email && (
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '10px 14px', background: '#F5F8FC', borderRadius: '10px' }}>
                      ...
                      <div>
                        <p style={{ fontFamily: 'var(--font-ui)', fontSize: '0.55rem', fontWeight: 700, color: '#96AFCA', textTransform: 'uppercase' as const, letterSpacing: '0.1em', margin: '0 0 2px' }}>Email</p>
                  ...
                  {selected.phone && (
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '10px 14px', background: '#F5F8FC', borderRadius: '10px' }}>
                      ...
                      <div>
                        <p style={{ fontFamily: 'var(--font-ui)', fontSize: '0.55rem', fontWeight: 700, color: '#96AFCA', textTransform: 'uppercase' as const, letterSpacing: '0.1em', margin: '0 0 2px' }}>Phone</p>
