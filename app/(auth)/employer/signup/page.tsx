  ...
  return (
    <div className="auth-root">
      ...
      <div className="auth-left">
        <div style={{ position:'absolute', top:'-120px', right:'-120px', width:'350px', height:'350px', borderRadius:'50%', background:'radial-gradient(circle, rgba(15,185,177,0.18) 0%, transparent 70%)', pointerEvents:'none' }}/>
        <div style={{ position:'absolute', inset:0, pointerEvents:'none', backgroundImage:'radial-gradient(circle, rgba(15,185,177,0.07) 1px, transparent 1px)', backgroundSize:'28px 28px' }}/>
          ...
          <div style={{ flex:1, display:'flex', flexDirection:'column', justifyContent:'center', gap:'1.75rem' }}>
            <div>
              <div style={{ display:'flex', alignItems:'center', gap:'8px', marginBottom:'10px' }}>
                ...
                <span style={{ fontFamily:'var(--font-ui)', fontSize:'0.58rem', fontWeight:700, letterSpacing:'0.2em', textTransform:'uppercase', color:'#0FB9B1' }}>Employer Registration</span>
              </div>
              <h2 style={{ fontFamily:'var(--font-ui)', fontSize:'clamp(1.75rem,2.5vw,2.5rem)', fontWeight:800, color:'#fff', letterSpacing:'-0.03em', lineHeight:1.1, margin:'0 0 0.875rem' }}>
                Start building<br/>your dream team<br/>today.
              </h2>
              <p style={{ fontFamily:'var(--font-ui)', fontSize:'0.875rem', color:'rgba(255,255,255,0.55)', lineHeight:1.7, margin:0, maxWidth:'300px' }}>
                Post jobs, connect with specialist recruiters, and close roles faster than ever before.
              </p>
            </div>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:'10px' }}>
              {[
                'Access 1,500+ specialist recruiters',
        ...
        <div className="auth-form-wrap">
          ...
          <div style={{ marginBottom:'1.75rem' }}>
            <div style={{ display:'flex', alignItems:'center', gap:'8px', marginBottom:'8px' }}>
              <div style={{ width:'26px', height:'26px', borderRadius:'7px', background:'#EEF3F8', border:'1px solid #D0DBE8', display:'flex', alignItems:'center', justifyContent:'center' }}>
                <svg width="13" height="13" fill="none" stroke="#032655" strokeWidth={2} viewBox="0 0 24 24">
              ...
              <span style={{ fontFamily:'var(--font-ui)', fontSize:'0.58rem', fontWeight:700, letterSpacing:'0.18em', textTransform:'uppercase', color:'#5A7A9F' }}>
            ...
            <p style={{ fontFamily:'var(--font-ui)', fontSize:'0.82rem', color:'#5A7A9F', margin:0, lineHeight:1.6 }}>
              ...
              <Link href="/employer/login" style={{ color:'#0FB9B1', fontWeight:700, textDecoration:'none', borderBottom:'1px solid rgba(15,185,177,0.3)' }}>
                Sign in
              </Link>
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} style={{ display:'flex', flexDirection:'column', gap:'0.875rem' }}>
            ...
            <AuthField label="Company Name" type="text" value={companyName} onChange={e => setCompanyName(e.target.value)} placeholder="e.g. Acme Corp" focused={focused === 'company'} onFocus={() => setFocused('company')} onBlur={() => setFocused(null)} required
            ...
            <AuthField label="Username" type="text" value={username} onChange={e => setUsername(e.target.value)} placeholder="Choose a username" focused={focused === 'username'} onFocus={() => setFocused('username')} onBlur={() => setFocused(null)} required
            ...
            <AuthField label="Email Address" type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="you@company.com" focused={focused === 'email'} onFocus={() => setFocused('email')} onBlur={() => setFocused(null)} required
            ...
            <button
              ...
              style={{
                ...
                background: loading ? '#5A7A9F' : '#032655',
            ...
            <Link href="/recruiter/signup" style={{
              ...
              Sign up as a Recruiter instead
            </Link>
          </form>
        </div>
      </div>
