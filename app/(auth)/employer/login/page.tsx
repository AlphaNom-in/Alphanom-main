  ...
  return (
    <div className="auth-root">
      ...
      <div className="auth-left">
        ...
        <div style={{ position:'absolute', bottom:'-100px', left:'-100px', width:'300px', height:'300px', borderRadius:'50%', background:'radial-gradient(circle, rgba(255,255,255,0.04) 0%, transparent 70%)', pointerEvents:'none' }}/>
          ...
          <div style={{ flex:1, display:'flex', flexDirection:'column', justifyContent:'center', gap:'1.75rem' }}>
            <div>
              <div style={{ display:'flex', alignItems:'center', gap:'8px', marginBottom:'10px' }}>
                ...
                <span style={{ fontFamily:'var(--font-ui)', fontSize:'0.58rem', fontWeight:700, letterSpacing:'0.2em', textTransform:'uppercase', color:'#0FB9B1' }}>Employer Portal</span>
              </div>
              <h2 style={{ fontFamily:'var(--font-ui)', fontSize:'clamp(1.75rem,2.5vw,2.5rem)', fontWeight:800, color:'#fff', letterSpacing:'-0.03em', lineHeight:1.1, margin:'0 0 0.875rem' }}>
                Welcome back.<br/>Let's find your<br/>next great hire.
              </h2>
              <p style={{ fontFamily:'var(--font-ui)', fontSize:'0.875rem', color:'rgba(255,255,255,0.55)', lineHeight:1.7, margin:0, maxWidth:'300px' }}>
                Access your dashboard, review submissions, and manage your active job listings.
              </p>
            </div>
            ...
            <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'0.625rem' }}>
              {[
                { val:'200+',   lbl:'Companies Hiring' },
                { val:'1,500+', lbl:'Active Recruiters' },
      ...
      <div className="auth-right">
        ...
        <RoleTabs active="employer" mode="login" />
        ...
        <div className="auth-form-wrap">
          ...
          <div style={{ marginBottom:'1.75rem' }}>
            ...
            <p style={{ fontFamily:'var(--font-ui)', fontSize:'0.82rem', color:'#5A7A9F', margin:0, lineHeight:1.6 }}>
              ...
              <Link href="/employer/signup" style={{ color:'#0FB9B1', fontWeight:700, textDecoration:'none', borderBottom:'1px solid rgba(15,185,177,0.3)' }}>
                Create one free
              </Link>
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} style={{ display:'flex', flexDirection:'column', gap:'1rem' }}>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:'5px' }}>
              <AuthField
                ...
                suffix={
                  <button type="button" onClick={() => setShowPass(v => !v)}
                    style={{ background:'none', border:'none', cursor:'pointer', color:'#96AFCA', padding:'0', display:'flex', alignItems:'center' }}>
                    {showPass
              ...
              <div style={{ display:'flex', justifyContent:'flex-end' }}>
                <Link href="/auth/employer/forgot-password" style={{ fontFamily:'var(--font-ui)', fontSize:'0.7rem', fontWeight:600, color:'#5A7A9F', textDecoration:'none' }}>
                  Forgot password?
                </Link>
              </div>
            </div>
            ...
            {/* Switch portal */}
            <Link href="/recruiter/login" style={{
