...
const SIDE_STORIES = [
  {
    ...
    text: 'Closed 3 engineering roles in 60 days and earned ₹1.2L through AlphaNom — my most productive quarter yet.',
  ...
  },
  {
    ...
    text: 'Found highly relevant candidates from specialist recruiters instead of sorting through hundreds of resumes.',
  ...
  },
  {
    ...
    text: 'The transparency and recruiter-first workflow made it easy to manage submissions and track progress in one place.',
    stat: '11', statLabel: 'Placements',
    accentColor: '#0FB9B1', accentBg: 'rgba(15,185,177,0.1)', accentBorder: 'rgba(15,185,177,0.25)',
    tagColor: '#0A9E97', tagBg: '#D8F0EB',
  },
  {
    ...
    name: 'Ankit Mehta',
    role: 'Founder · Pune',
    text: 'AlphaNom cut our hiring cycle from 6 weeks to under 3 and the candidates actually matched our brief.',
    stat: '18', statLabel: 'Days to Hire',
